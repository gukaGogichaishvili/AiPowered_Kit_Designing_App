    ...
    <section className='max-w7x1 mx-auto'>
      <div>
        <h1 className='font-extrabold text-[#222328] text-[32px]'>
          ...
          <p className='mt-2 text-[#666e75]
           text-[16px] max-w-[500px]'>Create imaginative and 
           visually stunning images through DALL-E and share them with the community</p>
      </div>
      ...
      <form className='mt-16 max-w-3x1' onSubmit={handleSubmit}>
        <div className='flex flex-col gap-5'>
          ...
          type='text' 
          name='prompt' 
          placeholder='A plush bear toy sitting against a yellow wall'
           value={form.prompt}
            handlChange={handleChange}
            isSurpriseMe 
